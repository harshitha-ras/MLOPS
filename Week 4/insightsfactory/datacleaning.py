...
# Data
ticket_details_path = "Ticket Details.xlsx"
device_list_path = "Device List.xlsx"
ticket_details_df = pd.read_excel(ticket_details_path, sheet_name='Sheet1')
device_list_df = pd.read_excel(device_list_path, sheet_name='Sheet1')
